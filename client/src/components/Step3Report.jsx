  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-5 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <button
        onClick={downloadPDf} 
        className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-4 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>Download PDF</button>
      </div>
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className='bg-white reounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8'>
                ...
                skills.map((skill, index) => (
                  <div key={index}>
                    ...
                    <div className='bg-gray-200 h-2 sm:h-3 rounded-full'>
                      ...
                      style={{ width: `${skill.value * 10}%`}}></div>
                    </div>
                  </div>
                ))
              }
